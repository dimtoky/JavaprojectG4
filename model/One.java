 ...
 *
 */
public class One extends AI{
	
  private static String IMAGE = "monster_1";
	public One(Direction direction, IPosition position, IMobile target){
		super(direction, position, IMAGE, target, 'W');
